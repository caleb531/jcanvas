...
s.width,s.height),p.beginPath(),p.moveTo(s.x,s.y-q/2),p.bezierCurveTo(s.x-u/2,s.y-q/2,s.x-u/2,s.y+q/2,s.x,s.y+q/2),p.bezierCurveTo(s.x+u/2,s.y+q/2,s.x+u/2,s.y-q/2,s.x,s.y-q/2),s._event&&K(this[d],p,f),M(p,s);return this};d.fn.drawPolygon=function f(d){var p,s,u=x(new B,d),q=2*C/u.sides,j=C/u.sides,m=j+C/2,l=u.radius*Q(q/2),o,i,k;u.closed=v;for(p=0;p<this.length;p+=1)if(s=z(this[p])){G(this[p],d,f);J(s,u);H(p,s,u,2*u.radius);s.beginPath();for(k=0;k<u.sides;k+=1)o=u.x+P(u.radius*Q(m)),i=u.y+P(u.radius*
S(m)),s.lineTo(o,i),u.projection&&(o=u.x+P((l+l*u.projection)*Q(m+j)),i=u.y+P((l+l*u.projection)*S(m+j)),s.lineTo(o,i)),m+=q;u._event&&K(this[p],s,d);M(s,u)}return this};d.fn.drawLine=function n(d){var i,u,q=x(new B,d),j,m,l;for(i=0;i<this.length;i+=1)if(u=z(this[i])){G(this[i],d,n);J(u,q);U(q);H(i,u,q,0);j=1;for(u.beginPath();v;)if(m=q["x"+j],l=q["y"+j],m!==A&&l!==A)u.lineTo(m,l),j+=1;else break;q._event&&K(this[i],u,d);M(u,q)}return this};d.fn.drawQuad=function p(d){var i,q,j=x(new B,d),m,l,o,r,
k;for(i=0;i<this.length;i+=1)if(q=z(this[i])){G(this[i],d,p);J(q,j);U(j);H(i,q,j,0);m=2;q.beginPath();for(q.moveTo(j.x1,j.y1);v;)if(l=j["x"+m],o=j["y"+m],r=j["cx"+(m-1)],k=j["cy"+(m-1)],l!==A&&o!==A&&r!==A&&k!==A)q.quadraticCurveTo(r,k,l,o),m+=1;else break;j._event&&K(this[i],q,d);M(q,j)}return this};d.fn.drawBezier=function s(d){var q,j,i=x(new B,d),l,o,r,k,h,t,w,y;for(q=0;q<this.length;q+=1)if(j=z(this[q])){G(this[q],d,s);J(j,i);U(i);H(q,j,i,0);l=2;o=1;j.beginPath();for(j.moveTo(i.x1,i.y1);v;)if(r=
i["x"+l],k=i["y"+l],h=i["cx"+o],t=i["cy"+o],w=i["cx"+(o+1)],y=i["cy"+(o+1)],r!==A&&k!==A&&h!==A&&t!==A&&w!==A&&y!==A)j.bezierCurveTo(h,t,w,y,r,k),l+=1,o+=2;else break;i._event&&K(this[q],j,d);M(j,i)}return this};d.fn.drawText=function u(q){var j,m,l=x(new B,q),o,r,k,h;for(j=0;j<this.length;j+=1)if(d(this[j]),m=z(this[j])){G(this[j],q,u);J(m,l);m.textBaseline=l.baseline;m.textAlign=l.align;m.font=l.font;if(!j&&l.maxWidth!==i){o=m;r=l.text;h=l.maxWidth;var t=l.text.split(" "),w=[],y="";if(o.measureText(r).width<
h)w=[r];else for(;0<t.length;)o.measureText(t[0]).width>h||o.measureText(y+t[0]).width<h?y+=t.shift()+" ":(w.push(y),y=""),0===t.length&&w.push(y);o=w;o=o.join("\n").replace(/( (\n))|( $)/gi,"$2").split("\n")}else j||(o=(""+l.text).split("\n"));fa(this[j],j,m,l,o);H(j,m,l,l.width,l.height);j||(k=l.x,"left"===l.align?k-=l.width/2:"right"===l.align&&(k+=l.width/2));for(r=0;r<o.length;r+=1)m.shadowColor=l.shadowColor,h=l.y+r*l.height/o.length-(o.length-1)*l.height/o.length/2,m.fillText(o[r],k,h),"transparent"!==
l.fillStyle&&(m.shadowColor="transparent"),m.strokeText(o[r],l.x,h);l._event?(m.beginPath(),m.rect(l.x-l.width/2,l.y-l.height/2,l.width,l.height),m.restore(),K(this[j],m,q),m.closePath()):m.restore()}E=l;return this};d.fn.measureText=function(d){var i;i=d!==A&&"object"!==typeof d?this.getLayer(d):x(new B,d);(d=z(this[0]))&&i.text!==A&&fa(this[0],0,d,i,i.text.split("\n"));return i};d.fn.drawImage=function q(d){function m(q,k,m){return function(){k||((y=t.width/t.height,h.width===i&&h.sWidth===i&&(d.width=
...
2),0>h.sx-h.sWidth/2&&(h.sx=h.sWidth/2),0>h.sy-h.sHeight/2&&(h.sy=h.sHeight/2),h.sy+h.sHeight/2>t.height&&(h.sy=t.height-h.sHeight/2),h.width!==i&&h.height===i)?d.height=h.height=h.width/y:h.width===i&&h.height!==i?d.width=h.width=h.height*y:h.width===i&&h.height===i&&(d.width=h.width=t.width,d.height=h.height=t.height));H(k,m,h,h.width,h.height);m.drawImage(t,h.sx-h.sWidth/2,h.sy-h.sHeight/2,h.sWidth,h.sHeight,h.x-h.width/2,h.y-h.height/2,h.width,h.height);m.beginPath();m.rect(h.x-h.width/2,h.y-
h.height/2,h.width,h.height);h._event&&K(l[k],m,d);M(m,h);h.load&&h.load.call(q,d)}}var l=this,o,r,k,h=x(new B,d),t,w,y;w=h.source.getContext;h.source.src||w?(t=h.source,h.width=t.width,h.height=t.height):h.source&&(t=new W,t.src=h.source);for(r=0;r<l.length;r+=1)if(o=l[r],k=z(l[r]))G(l[r],d,q),J(k,h),t&&(t.complete||w?m(o,r,k)():(t.onload=m(o,r,k),t.src=t.src));return l};d.fn.createPattern=d.fn.pattern=function(d){function j(){k=l.createPattern(r,o.repeat);o.load&&o.load.call(m[0],k)}var m=this,
l,o=x(new B,d),r,k;(l=z(m[0]))?"function"===typeof o.source?(r=T.createElement("canvas"),r.width=o.width,r.height=o.height,d=z(r),o.source.call(r,d),j()):(d=o.source.getContext,o.source.src||d?r=o.source:(r=new W,r.src=o.source),r.complete||d?j():r.onload=j):k=i;return k};d.fn.createGradient=d.fn.gradient=function(d){var j,d=x(new B,d),m=[],l,o,r,k,h,t,w;if(j=z(this[0])){d.x1=d.x1||0;d.y1=d.y1||0;d.x2=d.x2||0;d.y2=d.y2||0;j=d.r1!==i||d.r2!==i?j.createRadialGradient(d.x1,d.y1,d.r1,d.x2,d.y2,d.r2):
j.createLinearGradient(d.x1,d.y1,d.x2,d.y2);for(k=1;d["c"+k]!==A;k+=1)d["s"+k]!==A?m.push(d["s"+k]):m.push(i);l=m.length;m[0]===i&&(m[0]=0);m[l-1]===i&&(m[l-1]=1);for(k=0;k<l;k+=1){if(m[k]!==i){t=1;w=0;o=m[k];for(h=k+1;h<l;h+=1)if(m[h]!==i){r=m[h];break}else t+=1;o>r&&(m[h]=m[k])}else m[k]===i&&(w+=1,m[k]=o+w*((r-o)/t));j.addColorStop(m[k],d["c"+(k+1)])}}else j=i;return j};d.fn.setPixels=function j(d){var i,o,r,k=x(new B,d),h={},t,w,y,v;for(o=0;o<this.length;o+=1)if(i=this[o],r=z(i)){G(this[o],d,
j);H(o,r,k,k.width,k.height);if(!k.x||!k.y||!k.width||!k.height)k.width=i.width,k.height=i.height,k.x=k.width/2,k.y=k.height/2;t=r.getImageData(k.x-k.width/2,k.y-k.height/2,k.width,k.height);w=t.data;v=w.length;h=[];if(k.each)for(y=0;y<v;y+=4)h.r=w[y],h.g=w[y+1],h.b=w[y+2],h.a=w[y+3],k.each.call(i,h),w[y]=h.r,w[y+1]=h.g,w[y+2]=h.b,w[y+3]=h.a;r.putImageData(t,k.x-k.width/2,k.y-k.height/2);r.restore()}return this};d.fn.getCanvasImage=function(d,m){var l=this[0];return l&&l.toDataURL?l.toDataURL("image/"+
d,m):i};d.support.canvas=T.createElement("canvas").getContext!==A;D.defaults=O;D.checkEvents=K;d.jCanvas=D})(jQuery,document,Image,Math,parseFloat,!0,!1,null);

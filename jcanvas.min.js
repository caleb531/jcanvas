...
m=y(this[l])){H(this[l],r,s);J(m,n);m.textBaseline=n.baseline;m.textAlign=n.align;m.font=n.font;if(!l&&n.maxWidth!==h){o=m;p=n.text;i=n.maxWidth;var t=n.text.split(" "),w=[],x="";if(o.measureText(p).width<i)w=[p];else for(;0<t.length;)o.measureText(x+t[0]).width<i?x+=t.shift()+" ":(w.push(x),x=""),0===t.length&&w.push(x);o=w;o=o.join("\n").replace(/( (\n))|( $)/gi,"$2").split("\n")}else l||(o=(""+n.text).split("\n"));ea(this[l],l,m,n,o);I(l,m,n,n.width,n.height);l||(j=n.x,"left"===n.align?j-=n.width/
2:"right"===n.align&&(j+=n.width/2));for(p=0;p<o.length;p+=1)m.shadowColor=n.shadowColor,i=n.y+p*n.height/o.length-(o.length-1)*n.height/o.length/2,m.fillText(o[p],j,i),"transparent"!==n.fillStyle&&(m.shadowColor="transparent"),m.strokeText(o[p],n.x,i);n._event?(m.beginPath(),m.rect(n.x-n.width/2,n.y-n.height/2,n.width,n.height),m.restore(),L(this[l],m,r),m.closePath()):m.restore()}E=n;return this};d.fn.measureText=function(d){var h;h=d!==z&&"object"!==typeof d?this.getLayer(d):A(new B,d);(d=y(this[0]))&&
h.text!==z&&ea(this[0],e,d,h,h.text.split("\n"));return h};d.fn.drawImage=function r(d){function m(m,r,j){return function(){r||((x=t.width/t.height,i.width===h&&i.sWidth===h&&(d.width=i.width=i.sWidth=t.width),i.height===h&&i.sHeight===h&&(d.height=i.height=i.sHeight=t.height),i.width===h&&i.sWidth!==h&&(i.width=i.sWidth),i.height===h&&i.sHeight!==h&&(i.height=i.sHeight),i.sWidth===h&&i.width!==h&&(d.sWidth=i.sWidth=t.width),i.sHeight===h&&i.height!==h&&(d.sHeight=i.sHeight=t.height),i.sx===h&&(i.sx=
i.cropFromCenter?t.width/2:0),i.sy===h&&(i.sy=i.cropFromCenter?t.height/2:0),i.cropFromCenter||(i.sx+=i.sWidth/2,i.sy+=i.sHeight/2),i.sx+i.sWidth/2>t.width&&(i.sx=t.width-i.sWidth/2),0>i.sx-i.sWidth/2&&(i.sx=i.sWidth/2),0>i.sy-i.sHeight/2&&(i.sy=i.sHeight/2),i.sy+i.sHeight/2>t.height&&(i.sy=t.height-i.sHeight/2),i.width!==h&&i.height===h)?d.height=i.height=i.width/x:i.width===h&&i.height!==h?d.width=i.width=i.height*x:i.width===h&&i.height===h&&(d.width=i.width=t.width,d.height=i.height=t.height));
I(r,j,i,i.width,i.height);j.drawImage(t,i.sx-i.sWidth/2,i.sy-i.sHeight/2,i.sWidth,i.sHeight,i.x-i.width/2,i.y-i.height/2,i.width,i.height);i._event?(j.beginPath(),j.rect(i.x-i.width/2,i.y-i.height/2,i.width,i.height),j.restore(),L(n[r],j,d),j.closePath()):j.restore();i.load&&i.load.call(m,d)}}var n=this,o,p,j,i=A(new B,d),t,w,x;w=i.source.getContext;i.source.src||w?(t=i.source,i.width=t.width,i.height=t.height):i.source&&(t=new V,t.src=i.source);for(p=0;p<n.length;p+=1)if(o=n[p],j=y(n[p]))H(n[p],
d,r),J(j,i),t&&(t.complete||w?m(o,p,j)():t.onload=m(o,p,j));return n};d.fn.createPattern=d.fn.pattern=function(d){function l(){j=n.createPattern(p,o.repeat);o.load&&o.load.call(m[0],j)}var m=this,n,o=A(new B,d),p,j;(n=y(m[0]))?"function"===typeof o.source?(p=S.createElement("canvas"),p.width=o.width,p.height=o.height,d=y(p),o.source.call(p,d),l()):(d=o.source.getContext,o.source.src||d?p=o.source:(p=new V,p.src=o.source),p.complete||d?l():p.onload=l):j=h;return j};d.fn.createGradient=d.fn.gradient=
function(d){var l,d=A(new B,d),m=[],n,o,p,j,i,t,w;if(l=y(this[0])){d.x1=d.x1||0;d.y1=d.y1||0;d.x2=d.x2||0;d.y2=d.y2||0;l=d.r1!==h||d.r2!==h?l.createRadialGradient(d.x1,d.y1,d.r1,d.x2,d.y2,d.r2):l.createLinearGradient(d.x1,d.y1,d.x2,d.y2);for(j=1;d["c"+j]!==z;j+=1)d["s"+j]!==z?m.push(d["s"+j]):m.push(h);n=m.length;m[0]===h&&(m[0]=0);m[n-1]===h&&(m[n-1]=1);for(j=0;j<n;j+=1){if(m[j]!==h){t=1;w=0;o=m[j];for(i=j+1;i<n;i+=1)if(m[i]!==h){p=m[i];break}else t+=1;o>p&&(m[i]=m[j])}else m[j]===h&&(w+=1,m[j]=
o+w*((p-o)/t));l.addColorStop(m[j],d["c"+(j+1)])}}else l=h;return l};d.fn.setPixels=function l(d){var h,o,p,j=A(new B,d),i={},t,w,x,v;for(o=0;o<this.length;o+=1)if(h=this[o],p=y(h)){H(this[o],d,l);I(o,p,j,j.width,j.height);if(!j.x||!j.y||!j.width||!j.height)j.width=h.width,j.height=h.height,j.x=j.width/2,j.y=j.height/2;t=p.getImageData(j.x-j.width/2,j.y-j.height/2,j.width,j.height);w=t.data;v=w.length;i=[];if(j.each)for(x=0;x<v;x+=4)i.r=w[x],i.g=w[x+1],i.b=w[x+2],i.a=w[x+3],j.each.call(h,i),w[x]=
i.r,w[x+1]=i.g,w[x+2]=i.b,w[x+3]=i.a;p.putImageData(t,j.x-j.width/2,j.y-j.height/2);p.restore()}return this};d.fn.getCanvasImage=function(d,m){var n=this[0];return n&&n.toDataURL?n.toDataURL("image/"+d,m):h};d.support.canvas=S.createElement("canvas").getContext!==z;G.defaults=O;d.jCanvas=G})(jQuery,document,Image,Math,parseFloat,!0,!1,null);

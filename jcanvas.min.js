...
(d.closed=v,t=d.x+d.width/2,p=d.y+d.height/2,0>t-n-2*j&&(j=(t-n)/2),0>p-r-2*j&&(j=(p-r)/2),f.moveTo(n+j,r),f.lineTo(t-j,r),f.arc(t-j,r+j,j,3*D/2,2*D,F),f.lineTo(t,p-j),f.arc(t-j,p-j,j,0,D/2,F),f.lineTo(n+j,p),f.arc(n+j,p-j,j,D/2,D,F),f.lineTo(n,r+j),f.arc(n+j,r+j,j,D,3*D/2,F)):f.rect(n,r,d.width,d.height),d._event&&K(this[h],f,e),L(f,d);return this};d.fn.drawArc=function e(h){var f,d,n=z(new B,h),h=h||{};!n.inDegrees&&360===n.end&&(h.end=n.end=2*D);for(f=0;f<this.length;f+=1)if(d=y(this[f]))G(this[f],
h,e),I(d,n),H(f,d,n,2*n.radius),d.beginPath(),d.arc(n.x,n.y,n.radius,n.start*n._toRad-D/2,n.end*n._toRad-D/2,n.ccw),n._event&&K(this[f],d,h),L(d,n);return this};d.fn.drawEllipse=function h(f){var d,n,r=z(new B,f),t=4*r.width/3,p=r.height;r.closed=v;for(d=0;d<this.length;d+=1)if(n=y(this[d]))G(this[d],f,h),I(n,r),H(d,n,r,r.width,r.height),n.beginPath(),n.moveTo(r.x,r.y-p/2),n.bezierCurveTo(r.x-t/2,r.y-p/2,r.x-t/2,r.y+p/2,r.x,r.y+p/2),n.bezierCurveTo(r.x+t/2,r.y+p/2,r.x+t/2,r.y-p/2,r.x,r.y-p/2),r._event&&
K(this[d],n,f),L(n,r);return this};d.fn.drawPolygon=function f(d){var n,r,t=z(new B,d),p=2*D/t.sides,j=D/t.sides,l=j+D/2,m=t.radius*U(p/2),o,i,k;t.closed=v;for(n=0;n<this.length;n+=1)if(r=y(this[n])){G(this[n],d,f);I(r,t);H(n,r,t,2*t.radius);r.beginPath();for(k=0;k<t.sides;k+=1)o=t.x+O(t.radius*U(l)),i=t.y+O(t.radius*fa(l)),r.lineTo(o,i),t.projection&&(o=t.x+O((m+m*t.projection)*U(l+j)),i=t.y+O((m+m*t.projection)*fa(l+j)),r.lineTo(o,i)),l+=p;t._event&&K(this[n],r,d);L(r,t)}return this};d.fn.drawLine=
function s(d){var i,t,p=z(new B,d),j,l,m;for(i=0;i<this.length;i+=1)if(t=y(this[i])){G(this[i],d,s);I(t,p);S(p);H(i,t,p,0);j=1;for(t.beginPath();v;)if(l=p["x"+j],m=p["y"+j],l!==A&&m!==A)t.lineTo(l,m),j+=1;else break;p._event&&K(this[i],t,d);L(t,p)}return this};d.fn.drawQuad=function n(d){var i,p,j=z(new B,d),l,m,o,q,k;for(i=0;i<this.length;i+=1)if(p=y(this[i])){G(this[i],d,n);I(p,j);S(j);H(i,p,j,0);l=2;p.beginPath();for(p.moveTo(j.x1,j.y1);v;)if(m=j["x"+l],o=j["y"+l],q=j["cx"+(l-1)],k=j["cy"+(l-1)],
m!==A&&o!==A&&q!==A&&k!==A)p.quadraticCurveTo(q,k,m,o),l+=1;else break;j._event&&K(this[i],p,d);L(p,j)}return this};d.fn.drawBezier=function r(d){var p,j,i=z(new B,d),m,o,q,k,g,u,w,x;for(p=0;p<this.length;p+=1)if(j=y(this[p])){G(this[p],d,r);I(j,i);S(i);H(p,j,i,0);m=2;o=1;j.beginPath();for(j.moveTo(i.x1,i.y1);v;)if(q=i["x"+m],k=i["y"+m],g=i["cx"+o],u=i["cy"+o],w=i["cx"+(o+1)],x=i["cy"+(o+1)],q!==A&&k!==A&&g!==A&&u!==A&&w!==A&&x!==A)j.bezierCurveTo(g,u,w,x,q,k),m+=1,o+=2;else break;i._event&&K(this[p],
...
i&&g.height!==i?d.width=g.width=g.height*x:g.width===i&&g.height===i&&(d.width=g.width=u.width,d.height=g.height=u.height));H(k,l,g,g.width,g.height);l.drawImage(u,g.sx-g.sWidth/2,g.sy-g.sHeight/2,g.sWidth,g.sHeight,g.x-g.width/2,g.y-g.height/2,g.width,g.height);g._event?(l.beginPath(),l.rect(g.x-g.width/2,g.y-g.height/2,g.width,g.height),l.restore(),K(m[k],l,d),l.closePath()):l.restore();g.load&&g.load.call(p,d)}}var m=this,o,q,k,g=z(new B,d),u,w,x;w=g.source.getContext;g.source.src||w?(u=g.source,
...
w=u.data;v=w.length;g=[];if(k.each)for(x=0;x<v;x+=4)g.r=w[x],g.g=w[x+1],g.b=w[x+2],g.a=w[x+3],k.each.call(i,g),w[x]=g.r,w[x+1]=g.g,w[x+2]=g.b,w[x+3]=g.a;q.putImageData(u,k.x-k.width/2,k.y-k.height/2);q.restore()}return this};d.fn.getCanvasImage=function(d,l){var m=this[0];return m&&m.toDataURL?m.toDataURL("image/"+d,l):i};d.support.canvas=R.createElement("canvas").getContext!==A;C.defaults=N;d.jCanvas=C})(jQuery,document,Image,Math,parseFloat,!0,!1,null);

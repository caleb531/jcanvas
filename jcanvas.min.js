...
0,h),g.splice(3,0,h),g.splice(4,0,h)):"function"===typeof g[2]&&(g.splice(2,0,h),g.splice(3,0,h)),g[3]===z)?(g[3]=h,g.splice(4,0,h)):"function"===typeof g[3]&&g.splice(3,0,h);for(f=0;f<this.length;f+=1)if(b=d(this[f]),k=y(this[f]))if((k=b.getLayer(g[0]))&&k.method!==d.fn.draw)ca(k),ca(g[1],v),k.style=T,d(k).animate(g[1],{duration:g[2],easing:d.easing[g[3]]?g[3]:h,complete:c(b,k),step:a(b,k)});return this};d.fn.animateLayerGroup=function(c){var a,b,f=[].slice.call(arguments,0),k,g;for(b=0;b<this.length;b+=
1){a=d(this[b]);k=a.getLayerGroup(c);for(g=0;g<k.length;g+=1)a.animateLayer.apply(a,[k[g]].concat(f.slice(1)))}};d.fn.delayLayer=function(c,a){var b,f,a=a||0;for(b=0;b<this.length;b+=1)f=d(this[b]).getLayer(c),d(f).delay(a);return this};d.fn.delayLayerGroup=function(c,a){var b,f,k,g,a=a||0;for(f=0;f<this.length;f+=1){b=d(this[f]);k=b.getLayerGroup(c);for(g=0;g<k.length;g+=1)b.delayLayer.call(b,c,a)}};d.fn.stopLayer=function(c,a){var b,f;for(b=0;b<this.length;b+=1)f=d(this[b]).getLayer(c),d(f).stop(a);
return this};d.fn.stopLayerGroup=function(c,a){var b,f,k,g;for(f=0;f<this.length;f+=1){b=d(this[f]);k=b.getLayerGroup(c);for(g=0;g<k.length;g+=1)b.stopLayer.call(b,c,a)}};(function(c){var a;for(a=0;a<c.length;a+=1)d.fx.step[c[a]]=ga})("color backgroundColor borderColor borderTopColor borderRightColor borderBottomColor borderLeftColor fillStyle outlineColor strokeStyle shadowColor".split(" "));N("click");N("dblclick");N("mousedown");N("mouseup");N("mousemove");N("mouseover");N("mouseout");d.event.fix=
function(c){var a,c=ha.call(d.event,c);if(c.pageX!==z&&c.offsetX===z&&(a=d(c.target).offset()))c.offsetX=c.pageX-a.left,c.offsetY=c.pageY-a.top;return c};d.fn.draw=function a(b){var f,k,b=b||{};"function"===typeof b&&(b={fn:b});for(f=0;f<this.length;f+=1)if((k=y(this[f]))&&b.fn)H(this[f],b,a),b.fn.call(this[f],k);return this};d.fn.clearCanvas=function(a){for(var b,f=A(new B,a),a=0;a<this.length;a+=1)if(b=y(this[a]))I(a,b,f,f.width,f.height),!f.x||!f.y||!f.width||!f.height?b.clearRect(0,0,this[a].width,
this[a].height):b.clearRect(f.x-f.width/2,f.y-f.height/2,f.width,f.height);return this};d.fn.saveCanvas=function(){var a,b;for(a=0;a<this.length;a+=1)(b=y(this[a]))&&b.save();return this};d.fn.restoreCanvas=function(){var a,b;for(a=0;a<this.length;a+=1)(b=y(this[a]))&&b.restore();return this};d.fn.translateCanvas=function(a){for(var b,f=A(new B,a),a=0;a<this.length;a+=1)if(b=y(this[a]))f.autosave&&b.save(),Y(b,f);return this};d.fn.scaleCanvas=function(a){for(var b,f=A(new B,a),a=0;a<this.length;a+=
1)if(b=y(this[a]))f.autosave&&b.save(),Z(b,f);return this};d.fn.rotateCanvas=function(a){for(var b,f=A(new B,a),a=0;a<this.length;a+=1)if(b=y(this[a]))f.autosave&&b.save(),$(b,f);return this};d.fn.drawRect=function b(f){var k,g,d=A(new B,f),q,h,s,r,l;for(k=0;k<this.length;k+=1)if(g=y(this[k]))H(this[k],f,b),J(g,d),I(k,g,d,d.width,d.height),g.beginPath(),q=d.x-d.width/2,h=d.y-d.height/2,(l=d.cornerRadius)?(d.closed=v,s=d.x+d.width/2,r=d.y+d.height/2,0>s-q-2*l&&(l=(s-q)/2),0>r-h-2*l&&(l=(r-h)/2),g.moveTo(q+
l,h),g.lineTo(s-l,h),g.arc(s-l,h+l,l,3*D/2,2*D,F),g.lineTo(s,r-l),g.arc(s-l,r-l,l,0,D/2,F),g.lineTo(q+l,r),g.arc(q+l,r-l,l,D/2,D,F),g.lineTo(q,h+l),g.arc(q+l,h+l,l,D,3*D/2,F)):g.rect(q,h,d.width,d.height),d._event&&L(this[k],g,f),M(g,d);return this};d.fn.drawArc=function f(d){var g,h,q=A(new B,d),d=d||{};!q.inDegrees&&360===q.end&&(d.end=q.end=2*D);for(g=0;g<this.length;g+=1)if(h=y(this[g]))H(this[g],d,f),J(h,q),I(g,h,q,2*q.radius),h.beginPath(),h.arc(q.x,q.y,q.radius,q.start*q._toRad-D/2,q.end*q._toRad-
D/2,q.ccw),q._event&&L(this[g],h,d),M(h,q);return this};d.fn.drawEllipse=function k(g){var d,h,u=A(new B,g),s=4*u.width/3,r=u.height;u.closed=v;for(d=0;d<this.length;d+=1)if(h=y(this[d]))H(this[d],g,k),J(h,u),I(d,h,u,u.width,u.height),h.beginPath(),h.moveTo(u.x,u.y-r/2),h.bezierCurveTo(u.x-s/2,u.y-r/2,u.x-s/2,u.y+r/2,u.x,u.y+r/2),h.bezierCurveTo(u.x+s/2,u.y+r/2,u.x+s/2,u.y-r/2,u.x,u.y-r/2),u._event&&L(this[d],h,g),M(h,u);return this};d.fn.drawPolygon=function g(d){var h,u,s=A(new B,d),r=2*D/s.sides,
l=D/s.sides,m=l+D/2,n=s.radius*U(r/2),o,p,j;s.closed=v;for(h=0;h<this.length;h+=1)if(u=y(this[h])){H(this[h],d,g);J(u,s);I(h,u,s,2*s.radius);u.beginPath();for(j=0;j<s.sides;j+=1)o=s.x+P(s.radius*U(m)),p=s.y+P(s.radius*fa(m)),u.lineTo(o,p),s.projection&&(o=s.x+P((n+n*s.projection)*U(m+l)),p=s.y+P((n+n*s.projection)*fa(m+l)),u.lineTo(o,p)),m+=r;s._event&&L(this[h],u,d);M(u,s)}return this};d.fn.drawLine=function C(d){var h,s,r=A(new B,d),l,m,n;for(h=0;h<this.length;h+=1)if(s=y(this[h])){H(this[h],d,
C);J(s,r);I(h,s,r,0);l=1;for(s.beginPath();v;)if(m=r["x"+l],n=r["y"+l],m!==z&&n!==z)s.lineTo(m,n),l+=1;else break;r._event&&L(this[h],s,d);M(s,r)}return this};d.fn.drawQuad=function q(d){var h,r,l=A(new B,d),m,n,o,p,j;for(h=0;h<this.length;h+=1)if(r=y(this[h])){H(this[h],d,q);J(r,l);I(h,r,l,0);m=2;r.beginPath();for(r.moveTo(l.x1,l.y1);v;)if(n=l["x"+m],o=l["y"+m],p=l["cx"+(m-1)],j=l["cy"+(m-1)],n!==z&&o!==z&&p!==z&&j!==z)r.quadraticCurveTo(p,j,n,o),m+=1;else break;l._event&&L(this[h],r,d);M(r,l)}return this};
d.fn.drawBezier=function u(d){var h,l,m=A(new B,d),n,o,p,j,i,t,w,x;for(h=0;h<this.length;h+=1)if(l=y(this[h])){H(this[h],d,u);J(l,m);I(h,l,m,0);n=2;o=1;l.beginPath();for(l.moveTo(m.x1,m.y1);v;)if(p=m["x"+n],j=m["y"+n],i=m["cx"+o],t=m["cy"+o],w=m["cx"+(o+1)],x=m["cy"+(o+1)],p!==z&&j!==z&&i!==z&&t!==z&&w!==z&&x!==z)l.bezierCurveTo(i,t,w,x,p,j),n+=1,o+=2;else break;m._event&&L(this[h],l,d);M(l,m)}return this};d.fn.drawText=function s(r){var l,m,n=A(new B,r),o,p,j,i;for(l=0;l<this.length;l+=1)if(d(this[l]),
m=y(this[l])){H(this[l],r,s);J(m,n);m.textBaseline=n.baseline;m.textAlign=n.align;m.font=n.font;if(!l&&n.maxWidth!==h){o=m;p=n.text;i=n.maxWidth;var t=n.text.split(" "),w=[],x="";if(o.measureText(p).width<i)w=[p];else for(;0<t.length;)o.measureText(x+t[0]).width<i?x+=t.shift()+" ":(w.push(x),x=""),0===t.length&&w.push(x);o=w;o=o.join("\n").replace(/( (\n))|( $)/gi,"$2").split("\n")}else l||(o=n.text.split("\n"));ea(this[l],l,m,n,o);I(l,m,n,n.width,n.height);l||(j=n.x,"left"===n.align?j-=n.width/2:
"right"===n.align&&(j+=n.width/2));for(p=0;p<o.length;p+=1)i=n.y+p*n.height/o.length-(o.length-1)*n.height/o.length/2,m.fillText(o[p],j,i),"transparent"!==n.fillStyle&&(m.shadowColor="transparent"),m.strokeText(o[p],n.x,i);n._event?(m.beginPath(),m.rect(n.x-n.width/2,n.y-n.height/2,n.width,n.height),m.restore(),L(this[l],m,r),m.closePath()):m.restore()}E=n;return this};d.fn.measureText=function(d){var h;h=d!==z&&"object"!==typeof d?this.getLayer(d):A(new B,d);(d=y(this[0]))&&h.text!==z&&ea(this[0],
...
2:0),i.sy===h&&(i.sy=i.cropFromCenter?t.height/2:0),i.cropFromCenter||(i.sx+=i.sWidth/2,i.sy+=i.sHeight/2),i.sx+i.sWidth/2>t.width&&(i.sx=t.width-i.sWidth/2),0>i.sx-i.sWidth/2&&(i.sx=i.sWidth/2),0>i.sy-i.sHeight/2&&(i.sy=i.sHeight/2),i.sy+i.sHeight/2>t.height&&(i.sy=t.height-i.sHeight/2),i.width!==h&&i.height===h)?d.height=i.height=i.width/x:i.width===h&&i.height!==h?d.width=i.width=i.height*x:i.width===h&&i.height===h&&(d.width=i.width=t.width,d.height=i.height=t.height));I(r,j,i,i.width,i.height);
j.drawImage(t,i.sx-i.sWidth/2,i.sy-i.sHeight/2,i.sWidth,i.sHeight,i.x-i.width/2,i.y-i.height/2,i.width,i.height);i._event?(j.beginPath(),j.rect(i.x-i.width/2,i.y-i.height/2,i.width,i.height),j.restore(),L(n[r],j,d),j.closePath()):j.restore();i.load&&i.load.call(m,d)}}var n=this,o,p,j,i=A(new B,d),t,w,x;w=i.source.getContext;i.source.src||w?(t=i.source,i.width=t.width,i.height=t.height):i.source&&(t=new V,t.src=i.source);for(p=0;p<n.length;p+=1)if(o=n[p],j=y(n[p]))H(n[p],d,r),J(j,i),t&&(t.complete||
w?m(o,p,j)():t.onload=m(o,p,j));return n};d.fn.createPattern=d.fn.pattern=function(d){function l(){j=n.createPattern(p,o.repeat);o.load&&o.load.call(m[0],j)}var m=this,n,o=A(new B,d),p,j;(n=y(m[0]))?"function"===typeof o.source?(p=S.createElement("canvas"),p.width=o.width,p.height=o.height,d=y(p),o.source.call(p,d),l()):(d=o.source.getContext,o.source.src||d?p=o.source:(p=new V,p.src=o.source),p.complete||d?l():p.onload=l):j=h;return j};d.fn.createGradient=d.fn.gradient=function(d){var l,d=A(new B,
d),m=[],n,o,p,j,i,t,w;if(l=y(this[0])){d.x1=d.x1||0;d.y1=d.y1||0;d.x2=d.x2||0;d.y2=d.y2||0;l=d.r1!==h||d.r2!==h?l.createRadialGradient(d.x1,d.y1,d.r1,d.x2,d.y2,d.r2):l.createLinearGradient(d.x1,d.y1,d.x2,d.y2);for(j=1;d["c"+j]!==z;j+=1)d["s"+j]!==z?m.push(d["s"+j]):m.push(h);n=m.length;m[0]===h&&(m[0]=0);m[n-1]===h&&(m[n-1]=1);for(j=0;j<n;j+=1){if(m[j]!==h){t=1;w=0;o=m[j];for(i=j+1;i<n;i+=1)if(m[i]!==h){p=m[i];break}else t+=1;o>p&&(m[i]=m[j])}else m[j]===h&&(w+=1,m[j]=o+w*((p-o)/t));l.addColorStop(m[j],
d["c"+(j+1)])}}else l=h;return l};d.fn.setPixels=function l(d){var h,o,p,j=A(new B,d),i={},t,w,x,v;for(o=0;o<this.length;o+=1)if(h=this[o],p=y(h)){H(this[o],d,l);I(o,p,j,j.width,j.height);if(!j.x||!j.y||!j.width||!j.height)j.width=h.width,j.height=h.height,j.x=j.width/2,j.y=j.height/2;t=p.getImageData(j.x-j.width/2,j.y-j.height/2,j.width,j.height);w=t.data;v=w.length;i=[];if(j.each)for(x=0;x<v;x+=4)i.r=w[x],i.g=w[x+1],i.b=w[x+2],i.a=w[x+3],j.each.call(h,i),w[x]=i.r,w[x+1]=i.g,w[x+2]=i.b,w[x+3]=i.a;
p.putImageData(t,j.x-j.width/2,j.y-j.height/2);p.restore()}return this};d.fn.getCanvasImage=function(d,m){var n=this[0];return n&&n.toDataURL?n.toDataURL("image/"+d,m):h};d.support.canvas=S.createElement("canvas").getContext!==z;G.defaults=O;d.jCanvas=G})(jQuery,document,Image,Math,parseFloat,!0,!1,null);

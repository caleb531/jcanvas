...
"mousemove","mouseup"];for(b=0;b<c.length;b+=1)g=c[b],A.events[g](e,n);n.mouseout||(e.bind("mouseout.jCanvas",function(){n.drag={};e.drawLayers()}),n.mouseout=o)}}a.layer=o;a._layer=o;a.index===s&&(a.index=i.length);i.splice(a.index,0,a)}}function ea(c){var a;for(a=0;a<H.length;a+=1)c[H[a]]=c["_"+H[a]]}function fa(c){var a;for(a=0;a<H.length;a+=1)c["_"+H[a]]=c[H[a]],delete c[H[a]]}function ga(c){var a,b,e=[],i=1;c.match(/^#?[a-z0-9]+$/i)&&("transparent"===c&&(c="rgba(0,0,0,0)"),b=Q.head,a=b.style.color,
...
G(this[d],n,g),I(n,f);return this};d.fn.drawPolygon=function g(d){var f,y,r=w(new x,d),t=2*z/r.sides,j=z/r.sides,l=j+z/2,m=r.radius*V(t/2),p,q,k;r.closed=o;for(f=0;f<this.length;f+=1)if(y=v(this[f])){D(this[f],d,g);F(y,r);E(f,y,r,2*r.radius);y.beginPath();for(k=0;k<r.sides;k+=1)p=r.x+N(r.radius*V(l)),q=r.y+N(r.radius*ia(l)),y.lineTo(p,q),r.projection&&(p=r.x+N((m+m*r.projection)*V(l+j)),q=r.y+N((m+m*r.projection)*ia(l+j)),y.lineTo(p,q)),l+=t;r._event&&G(this[f],y,d);I(y,r)}return this};d.fn.drawLine=
...
p!==s&&q!==s&&k!==s)t.quadraticCurveTo(q,k,m,p),l+=1;else break;j._event&&G(this[f],t,d);I(t,j)}return this};d.fn.drawBezier=function y(d){var f,j,l=w(new x,d),m,p,q,k,h,u,W,X;for(f=0;f<this.length;f+=1)if(j=v(this[f])){D(this[f],d,y);F(j,l);E(f,j,l,0);m=2;p=1;j.beginPath();for(j.moveTo(l.x1,l.y1);o;)if(q=l["x"+m],k=l["y"+m],h=l["cx"+p],u=l["cy"+p],W=l["cx"+(p+1)],X=l["cy"+(p+1)],q!==s&&k!==s&&h!==s&&u!==s&&W!==s&&X!==s)j.bezierCurveTo(h,u,W,X,q,k),m+=1,p+=2;else break;l._event&&G(this[f],j,d);I(j,
l)}return this};d.fn.drawText=function r(f){var j,l,m=w(new x,f);for(j=0;j<this.length;j+=1)if(d(this[j]),l=v(this[j]))(D(this[j],f,r),F(l,m),l.textBaseline=m.baseline,l.textAlign=m.align,l.font=m.font,ha(this[j],l,m),E(j,l,m,m.width,m.height),l.fillText(m.text,m.x,m.y),"transparent"!==m.fillStyle&&(l.shadowColor="transparent"),l.strokeText(m.text,m.x,m.y),m._event)?(l.beginPath(),l.rect(m.x-m.width/2,m.y-m.height/2,m.width,m.height),l.restore(),G(this[j],l,f),l.closePath()):l.restore();R=m.text;
S=m.font;T=m.width;U=m.height;return this};d.fn.measureText=function(d){var f;f=d&&"object"!==typeof d?this.getLayer(d):w(new x,d);(d=v(this[0]))&&ha(this[0],d,f);return f};d.fn.drawImage=function t(d){function l(l,t,k){return function(){t||((s=u.width/u.height,h.width===f&&h.sWidth===f&&(d.width=h.width=h.sWidth=u.width),h.height===f&&h.sHeight===f&&(d.height=h.height=h.sHeight=u.height),h.width===f&&h.sWidth!==f&&(h.width=h.sWidth),h.height===f&&h.sHeight!==f&&(h.height=h.sHeight),h.sWidth===f&&

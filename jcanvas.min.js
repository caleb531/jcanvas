...
(b.method===d.fn.draw?b.fn.call(c[0],a):b.method&&b.method.call(c,b))}function K(c,a,b,e){var h,f={};a._args=b;a.canvas=c;if(a.draggable||f.group)a.layer=q,a.draggable=q;a.layer&&!a._layer&&(b=d(c),h=b.getLayers(),a.method=e?e:a.method?d.fn[a.method]:a.type?d.fn[ra[a.type]]:function(){},c=L(c),f=new F(a),oa(b,c,f),pa(b,c,f),ma(b,c,f),na(b,c,f),f.layer=q,f._layer=q,f.index===v&&(f.index=h.length),h.splice(f.index,0,f));return f}function sa(c){var a;for(a=0;a<T.length;a+=1)c[T[a]]=c["_"+T[a]]}function ta(c,
a){var b;for(b=0;b<T.length;b+=1)c["_"+T[b]]=c[T[b]],ga[T[b]]=1,a&&delete c[T[b]]}function ua(c){var a,b,e=[],h=1;c.match(/^#?\w+$/i)&&("transparent"===c&&(c="rgba(0,0,0,0)"),b=da.head,a=b.style.color,b.style.color=c,c=d.css(b,"color"),b.style.color=a);c.match(/^rgb/i)&&(e=c.match(/\d+/gi),c.match(/%/gi)&&(h=2.55),e[0]*=h,e[1]*=h,e[2]*=h,e[3]=e[3]!==v?ka(e[3]):1);return e}function za(c){var a=3,b;"object"!==typeof c.start&&(c.start=ua(c.start),c.end=ua(c.end));c.now=[];if(1!==c.start[3]||1!==c.end[3])a=
4;for(b=0;b<a;b+=1)c.now[b]=c.start[b]+(c.end[b]-c.start[b])*c.pos,3>b&&(c.now[b]=Aa(c.now[b]));1!==c.start[3]||1!==c.end[3]?c.now="rgba("+c.now.join(",")+")":(c.now.slice(0,3),c.now="rgb("+c.now.join(",")+")");c.elem.nodeName?c.elem.style[c.prop]=c.now:c.elem[c.prop]=c.now}function fa(c){"ontouchstart"in window&&ha[c]&&(c=ha[c]);return c}function S(c){M.events[c]=function(a,b){c=fa(c);var e="mouseover"===c||"mouseout"===c?"mousemove":c,h=b.event;b.events[e]||(a.bind(e+".jCanvas",function(b){h.x=
b.offsetX;h.y=b.offsetY;h.type=e;h.event=b;a.drawLayers({resetFire:q});b.preventDefault()}),b.events[e]=q)}}function P(c,a,b){var e,h,f,d;b=b._args;b._event&&(c=L(c),e=c.event,a=a.isPointInPath(e.x,e.y),h=c.transforms,b.eventX=b.mouseX=e.x,b.eventY=b.mouseY=e.y,b.event=e.event,d=c.transforms.rotate,e=b.eventX,f=b.eventY,0!==d?(b._eventX=e*W(-d)-f*X(-d),b._eventY=f*W(-d)+e*X(-d)):(b._eventX=e,b._eventY=f),b._eventX/=h.scaleX,b._eventY/=h.scaleY,!a&&(b._hovered&&!b._fired)&&(b._mousedout=q),a&&c.intersects.push(b))}

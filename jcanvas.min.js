...
u;c=["mousedown","mousemove","mouseup"];for(b=0;b<c.length;b+=1)f=c[b],E.events[f](e,p);p.mouseout||(e.bind("mouseout.jCanvas",function(){p.drag={};e.drawLayers()}),p.mouseout=u)}}a.layer=u;a._layer=u;a.index===y&&(a.index=i.length);i.splice(a.index,0,a)}}function ha(c){var a;for(a=0;a<I.length;a+=1)c[I[a]]=c["_"+I[a]]}function ia(c){var a;for(a=0;a<I.length;a+=1)c["_"+I[a]]=c[I[a]],delete c[I[a]],Z[I[a]]=1}function ja(c){var a,b,e=[],i=1;c.match(/^#?[a-z0-9]+$/i)&&("transparent"===c&&(c="rgba(0,0,0,0)"),
b=S.head,a=b.style.color,b.style.color=c,c=d.css(b,"color"),b.style.color=a);c.match(/^rgb/i)&&(e=c.match(/[0-9]+/gi),c.match(/%/gi)&&(i=2.55),e[0]*=i,e[1]*=i,e[2]*=i,e[3]=e[3]!==y?ba(e[3]):1);return e}function ma(c){var a=3,b;"object"!==typeof c.start&&(c.start=ja(c.start),c.end=ja(c.end));c.now=[];if(1!==c.start[3]||1!==c.end[3])a=4;for(b=0;b<a;b+=1)c.now[b]=c.start[b]+(c.end[b]-c.start[b])*c.pos,3>b&&(c.now[b]=P(c.now[b]));1!==c.start[3]||1!==c.end[3]?c.now="rgba("+c.now.join(",")+")":(c.now.slice(0,
3),c.now="rgb("+c.now.join(",")+")");c.elem.nodeName?c.elem.style[c.prop]=c.now:c.elem[c.prop]=c.now}function L(c){E.events[c]=function(a,b){var e="mouseover"===c||"mouseout"===c?"mousemove":c,i=b.event;b[e]||(a.bind(e+".jCanvas",function(b){i.x=b.offsetX;i.y=b.offsetY;i.type=e;a.drawLayers(u);b.preventDefault()}),b[e]=u)}}function J(c,a,b){var c=R(c),e=c.event,a=a.isPointInPath(e.x,e.y);b.mouseX=e.x;b.mouseY=e.y;!a&&(b._hovered&&!b._fired)&&(b._mousedout=u);a&&c.intersects.push(b)}function ka(c,
a,b,e){var i,f=/\b(\d*\.?\d*)\w\w\b/gi,B;if(T===b.text&&U===b.font&&V===b.maxWidth&&W===b.lineHeight)b.width=X,b.height=Y;else{b.width=a.measureText(e[0]).width;for(i=1;i<e.length;i+=1)B=a.measureText(e[i]).width,B>b.width&&(b.width=B);a=c.style.fontSize;if(i=b.font.match(f))c.style.fontSize=b.font.match(f)[0];b.height=ba(d.css(c,"fontSize"))*e.length*b.lineHeight;c.style.fontSize=a}}var O,ca,z=d.extend,P=Q.round,C=Q.PI,la=Q.sin,$=Q.cos,na=d.event.fix;Y=X=W=V=U=T=N=M=void 0;var I,Z;d.fn.jCanvas=E;
E.version="6.1b";E.events={};O={angle:0,align:"center",autosave:u,baseline:"middle",bringToFront:D,ccw:D,closed:D,compositing:"source-over",cornerRadius:0,cropFromCenter:u,draggable:D,disableDrag:D,each:g,end:360,fillStyle:"transparent",font:"12pt sans-serif",fromCenter:u,height:g,inDegrees:u,lineHeight:1,load:g,mask:D,maxWidth:g,method:g,miterLimit:10,opacity:1,projection:0,r1:g,r2:g,radius:0,repeat:"repeat",rotate:0,rounded:D,scale:1,scaleX:1,scaleY:1,shadowBlur:0,shadowColor:"transparent",shadowX:0,
shadowY:0,sHeight:g,sides:3,source:"",start:0,strokeCap:"butt",strokeJoin:"miter",strokeStyle:"transparent",strokeWidth:1,sWidth:g,sx:g,sy:g,text:"",translate:0,translateX:0,translateY:0,visible:u,width:g,x:0,y:0};E();E.extend=function(c){O=z(O,c.props);E();c.name&&(d.fn[c.name]=function b(e){var i,f,d,p=z(new A,e);for(f=0;f<this.length;f+=1)if(i=this[f],d=x(i))F(this[f],e,b),H(d,p),c.fn.call(i,d,p);return this});return d.fn[c.name]};d.fn.getLayers=function(){var c=this[0];return!c||!c.getContext?
...
b.splice(e,1)}return this};d.fn.removeLayers=function(){var c,a;for(a=0;a<this.length;a+=1)c=d(this[a]).getLayers(),c.length=0;return this};d.fn.getLayerGroup=function(c){var a=this.getLayers(),b=[],e;if(c!==y)for(e=0;e<a.length;e+=1)a[e].group===c&&b.push(a[e]);return b};d.fn.setLayerGroup=function(c,a){var b,e,i;for(b=0;b<this.length;b+=1){e=d(this[b]).getLayers();for(i=0;i<e.length;i+=1)e[i].group===c&&z(e[i],a)}return this};d.fn.removeLayerGroup=function(c){var a,b,e;if(c!==y)for(a=0;a<this.length;a+=
1){b=d(this[a]).getLayers();for(e=0;e<b.length;e+=1)b[e].group===c&&(b.splice(e,1),e-=1)}return this};d.fn.drawLayer=function(c){var a,b,e,i;for(a=0;a<this.length;a+=1)e=d(this[a]),b=x(this[a]),i=e.getLayer(c),ga(e,b,i);return this};d.fn.drawLayers=function(c){var a,b,e,i,f,B,p;for(b=0;b<this.length;b+=1)if(a=d(this[b]),e=x(this[b])){e.clearRect(0,0,this[b].width,this[b].height);M===this[b]?p=N:(p=R(this[b]),M=this[b],N=p);i=p.layers;for(B=0;B<i.length;B+=1)if(f=i[B],f.index=B,c&&(f._fired=D),ga(a,
e,f),f._mousedout)f._mousedout=D,f._fired=u,f._hovered=D,f.mouseout&&f.mouseout.call(this[b],f);f=p.intersects[p.intersects.length-1]||{};a=p.event;a=a.type;B=f[a];e=p.drag;if(f._event){if((f.mouseover||f.mouseout)&&!f._hovered&&!f._fired)f._fired=u,f._hovered=u,f.mouseover&&f.mouseover.call(this[b],f);B&&!f._fired&&(f._fired=u,B.call(this[b],f));f.draggable&&(!f.disableDrag&&"mousedown"===a)&&(f.bringToFront&&(i.splice(f.index,1),f.index=i.push(f)),e.layer=f,e.dragging=u,e.startX=f.x,e.startY=f.y,
e.endX=f.mouseX,e.endY=f.mouseY,f.dragstart&&f.dragstart.call(this[b],f))}if(e.layer&&(e.dragging&&"mouseup"===a&&(e.layer.dragstop&&e.layer.dragstop.call(this[b],e.layer),p.drag={}),e.dragging&&"mousemove"===a))e.layer.x=e.layer.mouseX-(e.endX-e.startX),e.layer.y=e.layer.mouseY-(e.endY-e.startY),e.layer.drag&&e.layer.drag.call(this[b],e.layer)}p.intersects=[];return this};d.fn.addLayer=function(c){var a,b,c=c||{};for(a=0;a<this.length;a+=1)if(b=x(this[a]))c.layer=u,F(this[a],c);return this};I=["width",
...
f.arc(r-k,g+k,k,3*C/2,2*C,D),f.lineTo(r,q-k),f.arc(r-k,q-k,k,0,C/2,D),f.lineTo(p+k,q),f.arc(p+k,q-k,k,C/2,C,D),f.lineTo(p,g+k),f.arc(p+k,g+k,k,C,3*C/2,D)):f.rect(p,g,d.width,d.height),d._event&&J(this[i],f,e),K(f,d);return this};d.fn.drawArc=function e(d){var f,g,p=z(new A,d),d=d||{};!p.inDegrees&&360===p.end&&(d.end=p.end=2*C);for(f=0;f<this.length;f+=1)if(g=x(this[f]))F(this[f],d,e),H(g,p),G(f,g,p,2*p.radius),g.beginPath(),g.arc(p.x,p.y,p.radius,p.start*p._toRad-C/2,p.end*p._toRad-C/2,p.ccw),p._event&&
J(this[f],g,d),K(g,p);return this};d.fn.drawEllipse=function i(f){var d,g,t=z(new A,f),r=4*t.width/3,q=t.height;t.closed=u;for(d=0;d<this.length;d+=1)if(g=x(this[d]))F(this[d],f,i),H(g,t),G(d,g,t,t.width,t.height),g.beginPath(),g.moveTo(t.x,t.y-q/2),g.bezierCurveTo(t.x-r/2,t.y-q/2,t.x-r/2,t.y+q/2,t.x,t.y+q/2),g.bezierCurveTo(t.x+r/2,t.y+q/2,t.x+r/2,t.y-q/2,t.x,t.y-q/2),t._event&&J(this[d],g,f),K(g,t);return this};d.fn.drawPolygon=function f(d){var g,t,r=z(new A,d),q=2*C/r.sides,k=C/r.sides,l=k+C/
2,m=r.radius*$(q/2),n,o,j;r.closed=u;for(g=0;g<this.length;g+=1)if(t=x(this[g])){F(this[g],d,f);H(t,r);G(g,t,r,2*r.radius);t.beginPath();for(j=0;j<r.sides;j+=1)n=r.x+P(r.radius*$(l)),o=r.y+P(r.radius*la(l)),t.lineTo(n,o),r.projection&&(n=r.x+P((m+m*r.projection)*$(l+k)),o=r.y+P((m+m*r.projection)*la(l+k)),t.lineTo(n,o)),l+=q;r._event&&J(this[g],t,d);K(t,r)}return this};d.fn.drawLine=function B(d){var g,r,q=z(new A,d),k,l,m;for(g=0;g<this.length;g+=1)if(r=x(this[g])){F(this[g],d,B);H(r,q);G(g,r,q,
0);k=1;for(r.beginPath();u;)if(l=q["x"+k],m=q["y"+k],l!==y&&m!==y)r.lineTo(l,m),k+=1;else break;q._event&&J(this[g],r,d);K(r,q)}return this};d.fn.drawQuad=function p(d){var g,q,k=z(new A,d),l,m,n,o,j;for(g=0;g<this.length;g+=1)if(q=x(this[g])){F(this[g],d,p);H(q,k);G(g,q,k,0);l=2;q.beginPath();for(q.moveTo(k.x1,k.y1);u;)if(m=k["x"+l],n=k["y"+l],o=k["cx"+(l-1)],j=k["cy"+(l-1)],m!==y&&n!==y&&o!==y&&j!==y)q.quadraticCurveTo(o,j,m,n),l+=1;else break;k._event&&J(this[g],q,d);K(q,k)}return this};d.fn.drawBezier=
function t(d){var g,k,l=z(new A,d),m,n,o,j,h,s,v,w;for(g=0;g<this.length;g+=1)if(k=x(this[g])){F(this[g],d,t);H(k,l);G(g,k,l,0);m=2;n=1;k.beginPath();for(k.moveTo(l.x1,l.y1);u;)if(o=l["x"+m],j=l["y"+m],h=l["cx"+n],s=l["cy"+n],v=l["cx"+(n+1)],w=l["cy"+(n+1)],o!==y&&j!==y&&h!==y&&s!==y&&v!==y&&w!==y)k.bezierCurveTo(h,s,v,w,o,j),m+=1,n+=2;else break;l._event&&J(this[g],k,d);K(k,l)}return this};d.fn.drawText=function r(q){var k,l,m=z(new A,q),n,o,j,h;for(k=0;k<this.length;k+=1)if(d(this[k]),l=x(this[k])){F(this[k],

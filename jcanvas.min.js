...
a,b){var c=I(c),e=c.event,a=a.isPointInPath(e.x,e.y),g=c.transforms,f,n;b.mouseX=e.x;b.mouseY=e.y;n=c.transforms.rotate*C/180;e=b.mouseX;f=b.mouseY;b.mouseX=e*Q(-n)-f*S(-n);b.mouseY=f*Q(-n)+e*S(-n);b.mouseX/=g.scaleX;b.mouseY/=g.scaleY;!a&&(b._hovered&&!b._fired)&&(b._mousedout=v);a&&c.intersects.push(b)}function fa(c,a,b,e,g){var f=/\b(\d*\.?\d*)\w\w\b/gi,n;if(E.text===e.text&&E.font===e.font&&E.maxWidth===e.maxWidth&&E.lineHeight===e.lineHeight)e.width=E.width,e.height=E.height;else if(!a){e.width=

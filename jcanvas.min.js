...
(a=K(this[c]))&&(a=b.getLayer(d))&&a.visible&&a._method&&(a._next=h,a._method.call(b,a));return this};g.fn.drawLayers=function(d){var c,a,b,f,e,k,r,v,B,z,J;(r=d.index)||(r=0);for(a=0;a<this.length;a+=1)if(c=g(this[a]),b=K(this[a])){v=E(this[a]);d.clear!==w&&c.clearCanvas();b=v.layers;for(k=r;k<b.length;k+=1)if(f=b[k],f.index=k,d.resetFire&&(f._fired=w),B=c,z=f,e=k+1,z&&z.visible&&z._method&&(z._next=e?e:h,z._method.call(B,z)),f._masks=v.transforms.masks.slice(0),f._method===g.fn.drawImage&&f.visible){J=
!0;break}if(J)break;f=v;var y=e=z=B=void 0;B=h;for(z=f.intersecting.length-1;0<=z;z-=1)if(B=f.intersecting[z],B._masks){for(y=B._masks.length-1;0<=y;y-=1)if(e=B._masks[y],!e.intersects){B.intersects=w;break}if(B.intersects&&!B.intangible)break}B&&B.intangible&&(B=h);f=B;B=v.event;z=B.type;if(v.drag.layer){e=c;var y=v,H=z,u=void 0,q=void 0,m=void 0,A=m=void 0,F=void 0,m=u=u=m=void 0,m=y.drag,A=(q=m.layer)&&q.dragGroups||[],u=y.layers;if("mousemove"===H||"touchmove"===H){if(m.dragging||(m.dragging=
...
y.drag={}}e=v.lastIntersected;e===h||f===e||!e._hovered||e._fired||v.drag.dragging||(v.lastIntersected=h,e._fired=p,e._hovered=w,O(c,v,e,"mouseout"),c.css({cursor:v.cursor}));f&&(f[z]||V.mouseEvents[z]&&(z=V.mouseEvents[z]),f._event&&f.intersects&&(v.lastIntersected=f,!(f.mouseover||f.mouseout||f.cursors)||v.drag.dragging||f._hovered||f._fired||(f._fired=p,f._hovered=p,O(c,v,f,"mouseover")),f._fired||(f._fired=p,B.type=h,O(c,v,f,z)),!f.draggable||f.disableEvents||"mousedown"!==z&&"touchstart"!==z||
(v.drag.layer=f)));f!==h||v.drag.dragging||c.css({cursor:v.cursor});k===b.length&&(v.intersecting.length=0,v.transforms=ka(na),v.savedTransforms.length=0)}return this};g.fn.addLayer=function(d){var c,a;for(c=0;c<this.length;c+=1)if(a=K(this[c]))a=new G(d),a.layer=p,N(this[c],a,d);return this};T.props=["width","height","opacity","lineHeight"];T.propsObj={};g.fn.animateLayer=function(){function d(a,b,c){return function(){var d,f;for(f=0;f<T.props.length;f+=1)d=T.props[f],c[d]=c["_"+d];for(var k in c)c.hasOwnProperty(k)&&
-1!==k.indexOf(".")&&delete c[k];b.animating&&b.animated!==c||a.drawLayers();c._animating=w;b.animating=w;b.animated=h;e[4]&&e[4].call(a[0],c);O(a,b,c,"animateend")}}function c(a,b,c){return function(d,f){var k,g,h=!1;"_"===f.prop[0]&&(h=!0,f.prop=f.prop.replace("_",""),c[f.prop]=c["_"+f.prop]);-1!==f.prop.indexOf(".")&&(k=f.prop.split("."),g=k[0],k=k[1],c[g]&&(c[g][k]=f.now));c._pos!==f.pos&&(c._pos=f.pos,c._animating||b.animating||(c._animating=p,b.animating=p,b.animated=c),b.animating&&b.animated!==
c||a.drawLayers());e[5]&&e[5].call(a[0],d,f,c);O(a,b,c,"animate",f);h&&(f.prop="_"+f.prop)}}var a,b,f,e=ta.call(arguments,0),k,G;"object"===Z(e[2])?(e.splice(2,0,e[2].duration||h),e.splice(3,0,e[3].easing||h),e.splice(4,0,e[4].complete||h),e.splice(5,0,e[5].step||h)):(e[2]===r?(e.splice(2,0,h),e.splice(3,0,h),e.splice(4,0,h)):da(e[2])&&(e.splice(2,0,h),e.splice(3,0,h)),e[3]===r?(e[3]=h,e.splice(4,0,h)):da(e[3])&&e.splice(3,0,h));for(b=0;b<this.length;b+=1)if(a=g(this[b]),f=K(this[b]))f=E(this[b]),
...
(function(d){var c;for(c=0;c<d.length;c+=1)Za(d[c])})("click dblclick mousedown mouseup mousemove mouseover mouseout touchstart touchmove touchend".split(" "));g.event.fix=function(d){var c,a;d=bb.call(g.event,d);if(c=d.originalEvent)if(a=c.changedTouches,d.pageX!==r&&d.offsetX===r){if(c=g(d.currentTarget).offset())d.offsetX=d.pageX-c.left,d.offsetY=d.pageY-c.top}else a&&(c=g(d.currentTarget).offset())&&(d.offsetX=a[0].pageX-c.left,d.offsetY=a[0].pageY-c.top);return d};V.drawings={arc:"drawArc",bezier:"drawBezier",
ellipse:"drawEllipse","function":"draw",image:"drawImage",line:"drawLine",path:"drawPath",polygon:"drawPolygon",slice:"drawSlice",quadratic:"drawQuadratic",rectangle:"drawRect",text:"drawText",vector:"drawVector",save:"saveCanvas",restore:"restoreCanvas",rotate:"rotateCanvas",scale:"scaleCanvas",translate:"translateCanvas"};g.fn.draw=function c(a){var b,f,e=new G(a);if(V.drawings[e.type]&&"function"!==e.type)this[V.drawings[e.type]](a);else for(b=0;b<this.length;b+=1)if(g(this[b]),f=K(this[b]))e=
new G(a),N(this[b],e,a,c),e.visible&&e.fn&&e.fn.call(this[b],f,e);return this};g.fn.clearCanvas=function a(b){var f,e,k=new G(b);for(f=0;f<this.length;f+=1)if(e=K(this[f]))k.width===h||k.height===h?(e.save(),e.setTransform(1,0,0,1,0,0),e.clearRect(0,0,this[f].width,this[f].height),e.restore()):(N(this[f],k,b,a),Q(this[f],e,k,k.width,k.height),e.clearRect(k.x-k.width/2,k.y-k.height/2,k.width,k.height),k._transformed&&e.restore());return this};g.fn.saveCanvas=function b(f){var e,k,g,h,B;for(e=0;e<this.length;e+=
1)if(k=K(this[e]))for(h=E(this[e]),g=new G(f),N(this[e],g,f,b),B=0;B<g.count;B+=1)ea(k,h);return this};g.fn.restoreCanvas=function f(e){var k,g,h,B,z;for(k=0;k<this.length;k+=1)if(g=K(this[k]))for(B=E(this[k]),h=new G(e),N(this[k],h,e,f),z=0;z<h.count;z+=1){var J=g,y=B;0===y.savedTransforms.length?y.transforms=ka(na):(J.restore(),y.transforms=y.savedTransforms.pop())}return this};g.fn.rotateCanvas=function e(k){var g,h,B,z;for(g=0;g<this.length;g+=1)if(h=K(this[g]))z=E(this[g]),B=new G(k),N(this[g],
B,k,e),B.autosave&&ea(h,z),za(h,B,z.transforms);return this};g.fn.scaleCanvas=function k(g){var h,B,z,J;for(h=0;h<this.length;h+=1)if(B=K(this[h]))J=E(this[h]),z=new G(g),N(this[h],z,g,k),z.autosave&&ea(B,J),Aa(B,z,J.transforms);return this};g.fn.translateCanvas=function Ta(g){var h,z,J,y;for(h=0;h<this.length;h+=1)if(z=K(this[h]))y=E(this[h]),J=new G(g),N(this[h],J,g,Ta),J.autosave&&ea(z,y),Ba(z,J,y.transforms);return this};g.fn.drawRect=function v(g){var h,J,y,H,u,q,m,A,F;for(h=0;h<this.length;h+=
1)if(J=K(this[h]))y=new G(g),N(this[h],y,g,v),y.visible&&(R(this[h],J,y),Q(this[h],J,y,y.width,y.height),J.beginPath(),y.width&&y.height&&(H=y.x-y.width/2,u=y.y-y.height/2,(A=ab(y.cornerRadius))?(q=y.x+y.width/2,m=y.y+y.height/2,0>y.width&&(F=H,H=q,q=F),0>y.height&&(F=u,u=m,m=F),0>q-H-2*A&&(A=(q-H)/2),0>m-u-2*A&&(A=(m-u)/2),J.moveTo(H+A,u),J.lineTo(q-A,u),J.arc(q-A,u+A,A,3*D/2,2*D,w),J.lineTo(q,m-A),J.arc(q-A,m-A,A,0,D/2,w),J.lineTo(H+A,m),J.arc(H+A,m-A,A,D/2,D,w),J.lineTo(H,u+A),J.arc(H+A,u+A,A,
D,3*D/2,w),y.closed=p):J.rect(H,u,y.width,y.height)),S(this[h],J,y),U(this[h],J,y));return this};g.fn.drawArc=function B(g){var h,y,H;for(h=0;h<this.length;h+=1)if(y=K(this[h]))H=new G(g),N(this[h],H,g,B),H.visible&&(R(this[h],y,H),Q(this[h],y,H,2*H.radius),y.beginPath(),Ja(this[h],y,H,H),S(this[h],y,H),U(this[h],y,H));return this};g.fn.drawEllipse=function z(g){var h,H,u,q,m;for(h=0;h<this.length;h+=1)if(H=K(this[h]))u=new G(g),N(this[h],u,g,z),u.visible&&(R(this[h],H,u),Q(this[h],H,u,u.width,u.height),
q=4/3*u.width,m=u.height,H.beginPath(),H.moveTo(u.x,u.y-m/2),H.bezierCurveTo(u.x-q/2,u.y-m/2,u.x-q/2,u.y+m/2,u.x,u.y+m/2),H.bezierCurveTo(u.x+q/2,u.y+m/2,u.x+q/2,u.y-m/2,u.x,u.y-m/2),S(this[h],H,u),u.closed=p,U(this[h],H,u));return this};g.fn.drawPolygon=function J(g){var h,u,q,m,A,F,M,x,n,l;for(h=0;h<this.length;h+=1)if(u=K(this[h]))if(q=new G(g),N(this[h],q,g,J),q.visible){R(this[h],u,q);Q(this[h],u,q,2*q.radius);A=2*D/q.sides;F=A/2;m=F+D/2;M=q.radius*L(F);u.beginPath();for(l=0;l<q.sides;l+=1)x=
q.x+q.radius*L(m),n=q.y+q.radius*P(m),u.lineTo(x,n),q.concavity&&(x=q.x+(M+-M*q.concavity)*L(m+F),n=q.y+(M+-M*q.concavity)*P(m+F),u.lineTo(x,n)),m+=A;S(this[h],u,q);q.closed=p;U(this[h],u,q)}return this};g.fn.drawSlice=function y(h){var u,q,m,A,F;for(u=0;u<this.length;u+=1)if(g(this[u]),q=K(this[u]))m=new G(h),N(this[u],m,h,y),m.visible&&(R(this[u],q,m),Q(this[u],q,m,2*m.radius),m.start*=m._toRad,m.end*=m._toRad,m.start-=D/2,m.end-=D/2,m.start=Ia(m.start),m.end=Ia(m.end),m.end<m.start&&(m.end+=2*
D),A=(m.start+m.end)/2,F=m.radius*m.spread*L(A),A=m.radius*m.spread*P(A),m.x+=F,m.y+=A,q.beginPath(),q.arc(m.x,m.y,m.radius,m.start,m.end,m.ccw),q.lineTo(m.x,m.y),S(this[u],q,m),m.closed=p,U(this[u],q,m));return this};g.fn.drawLine=function H(h){var g,m,A;for(g=0;g<this.length;g+=1)if(m=K(this[g]))A=new G(h),N(this[g],A,h,H),A.visible&&(R(this[g],m,A),Q(this[g],m,A),m.beginPath(),La(this[g],m,A,A),S(this[g],m,A),U(this[g],m,A));return this};g.fn.drawQuadratic=function u(g){var h,A,F;for(h=0;h<this.length;h+=
1)if(A=K(this[h]))F=new G(g),N(this[h],F,g,u),F.visible&&(R(this[h],A,F),Q(this[h],A,F),A.beginPath(),Ma(this[h],A,F,F),S(this[h],A,F),U(this[h],A,F));return this};g.fn.drawBezier=function q(h){var g,F,M;for(g=0;g<this.length;g+=1)if(F=K(this[g]))M=new G(h),N(this[g],M,h,q),M.visible&&(R(this[g],F,M),Q(this[g],F,M),F.beginPath(),Na(this[g],F,M,M),S(this[g],F,M),U(this[g],F,M));return this};g.fn.drawVector=function m(g){var h,M,x;for(h=0;h<this.length;h+=1)if(M=K(this[h]))x=new G(g),N(this[h],x,g,
m),x.visible&&(R(this[h],M,x),Q(this[h],M,x),M.beginPath(),Qa(this[h],M,x,x),S(this[h],M,x),U(this[h],M,x));return this};g.fn.drawPath=function A(h){var g,x,n,l,C;for(g=0;g<this.length;g+=1)if(x=K(this[g]))if(n=new G(h),N(this[g],n,h,A),n.visible){R(this[g],x,n);Q(this[g],x,n);x.beginPath();for(l=1;p;)if(C=n["p"+l],C!==r)C=new G(C),"line"===C.type?La(this[g],x,n,C):"quadratic"===C.type?Ma(this[g],x,n,C):"bezier"===C.type?Na(this[g],x,n,C):"vector"===C.type?Qa(this[g],x,n,C):"arc"===C.type&&Ja(this[g],
x,n,C),l+=1;else break;S(this[g],x,n);U(this[g],x,n)}return this};g.fn.drawText=function F(M){var x,n,l,C,X,t,r,p,I,w;for(x=0;x<this.length;x+=1)if(g(this[x]),n=K(this[x]))if(l=new G(M),C=N(this[x],l,M,F),l.visible){R(this[x],n,l);n.textBaseline=l.baseline;n.textAlign=l.align;ra(this[x],n,l);X=l.maxWidth!==h?Ra(n,l):l.text.toString().split("\n");sa(this[x],n,l,X);C&&(C.width=l.width,C.height=l.height);Q(this[x],n,l,l.width,l.height);r=l.x;"left"===l.align?l.respectAlign?l.x+=l.width/2:r-=l.width/
2:"right"===l.align&&(l.respectAlign?l.x-=l.width/2:r+=l.width/2);if(l.radius)for(r=$(l.fontSize),l.letterSpacing===h&&(l.letterSpacing=r/500),t=0;t<X.length;t+=1){n.save();n.translate(l.x,l.y);C=X[t];p=C.length;n.rotate(-(D*l.letterSpacing*(p-1))/2);for(w=0;w<p;w+=1)I=C[w],0!==w&&n.rotate(D*l.letterSpacing),n.save(),n.translate(0,-l.radius),n.fillText(I,0,0),n.restore();l.radius-=r;l.letterSpacing+=r/(1E3*D);n.restore()}else for(t=0;t<X.length;t+=1)C=X[t],p=l.y+t*l.height/X.length-(X.length-1)*l.height/
X.length/2,n.shadowColor=l.shadowColor,n.fillText(C,r,p),"transparent"!==l.fillStyle&&(n.shadowColor="transparent"),0!==l.strokeWidth&&n.strokeText(C,r,p);p=0;"top"===l.baseline?p+=l.height/2:"bottom"===l.baseline&&(p-=l.height/2);l._event&&(n.beginPath(),n.rect(l.x-l.width/2,l.y-l.height/2+p,l.width,l.height),S(this[x],n,l),n.closePath());l._transformed&&n.restore()}aa.propCache=l;return this};g.fn.measureText=function(g){var h,x;h=this.getLayer(g);if(!h||h&&!h._layer)h=new G(g);if(g=K(this[0]))ra(this[0],
g,h),x=Ra(g,h),sa(this[0],g,h,x);return h};g.fn.drawImage=function M(x){function n(l,n,t,s,x){return function(){var C=g(l);R(l,n,s);s.width===h&&s.sWidth===h&&(s.width=s.sWidth=I.width);s.height===h&&s.sHeight===h&&(s.height=s.sHeight=I.height);x&&(x.width=s.width,x.height=s.height);s.sWidth!==h&&s.sHeight!==h&&s.sx!==h&&s.sy!==h?(s.width===h&&(s.width=s.sWidth),s.height===h&&(s.height=s.sHeight),s.cropFromCenter&&(s.sx+=s.sWidth/2,s.sy+=s.sHeight/2),0>s.sy-s.sHeight/2&&(s.sy=s.sHeight/2),s.sy+s.sHeight/
2>I.height&&(s.sy=I.height-s.sHeight/2),0>s.sx-s.sWidth/2&&(s.sx=s.sWidth/2),s.sx+s.sWidth/2>I.width&&(s.sx=I.width-s.sWidth/2),Q(l,n,s,s.width,s.height),n.drawImage(I,s.sx-s.sWidth/2,s.sy-s.sHeight/2,s.sWidth,s.sHeight,s.x-s.width/2,s.y-s.height/2,s.width,s.height)):(Q(l,n,s,s.width,s.height),n.drawImage(I,s.x-s.width/2,s.y-s.height/2,s.width,s.height));n.beginPath();n.rect(s.x-s.width/2,s.y-s.height/2,s.width,s.height);S(l,n,s);n.closePath();s._transformed&&n.restore();ya(n,t,s);s.layer?O(C,t,x,
"load"):s.load&&s.load.call(C[0],x);s.layer&&(x._masks=t.transforms.masks.slice(0),s._next&&C.drawLayers({clear:w,resetFire:p,index:s._next}))}}var l,C,r,t,ba,D,I,ua,L,P=aa.imageCache;for(C=0;C<this.length;C+=1)if(l=this[C],r=K(this[C]))t=E(this[C]),ba=new G(x),D=N(this[C],ba,x,M),ba.visible&&(L=ba.source,ua=L.getContext,L.src||ua?I=L:L&&(P[L]&&P[L].complete?I=P[L]:(I=new wa,L.match(/^data:/i)||(I.crossOrigin=ba.crossOrigin),I.src=L,P[L]=I)),I&&(I.complete||ua?n(l,r,t,ba,D)():(I.onload=n(l,r,t,ba,
D),I.src=I.src)));return this};g.fn.createPattern=function(r){function x(){t=l.createPattern(p,C.repeat);C.load&&C.load.call(n[0],t)}var n=this,l,C,p,t,w;(l=K(n[0]))?(C=new G(r),w=C.source,da(w)?(p=g("<canvas />")[0],p.width=C.width,p.height=C.height,r=K(p),w.call(p,r),x()):(r=w.getContext,w.src||r?p=w:(p=new wa,p.crossOrigin=C.crossOrigin,p.src=w),p.complete||r?x():(p.onload=x(),p.src=p.src))):t=h;return t};g.fn.createGradient=function(g){var x,n=[],l,p,w,t,D,E,I;g=new G(g);if(x=K(this[0])){g.x1=
g.x1||0;g.y1=g.y1||0;g.x2=g.x2||0;g.y2=g.y2||0;x=g.r1!==h&&g.r2!==h?x.createRadialGradient(g.x1,g.y1,g.r1,g.x2,g.y2,g.r2):x.createLinearGradient(g.x1,g.y1,g.x2,g.y2);for(t=1;g["c"+t]!==r;t+=1)g["s"+t]!==r?n.push(g["s"+t]):n.push(h);l=n.length;n[0]===h&&(n[0]=0);n[l-1]===h&&(n[l-1]=1);for(t=0;t<l;t+=1){if(n[t]!==h){E=1;I=0;p=n[t];for(D=t+1;D<l;D+=1)if(n[D]!==h){w=n[D];break}else E+=1;p>w&&(n[D]=n[t])}else n[t]===h&&(I+=1,n[t]=p+(w-p)/E*I);x.addColorStop(n[t],g["c"+(t+1)])}}else x=h;return x};g.fn.setPixels=
function x(g){var l,p,r,t,w,D,I,E,L;for(p=0;p<this.length;p+=1)if(l=this[p],r=K(l)){t=new G(g);N(l,t,g,x);Q(this[p],r,t,t.width,t.height);if(t.width===h||t.height===h)t.width=l.width,t.height=l.height,t.x=t.width/2,t.y=t.height/2;if(0!==t.width&&0!==t.height){D=r.getImageData(t.x-t.width/2,t.y-t.height/2,t.width,t.height);I=D.data;L=I.length;if(t.each)for(E=0;E<L;E+=4)w={r:I[E],g:I[E+1],b:I[E+2],a:I[E+3]},t.each.call(l,w,t),I[E]=w.r,I[E+1]=w.g,I[E+2]=w.b,I[E+3]=w.a;r.putImageData(D,t.x-t.width/2,
t.y-t.height/2);r.restore()}}return this};g.fn.getCanvasImage=function(g,n){var l,p=h;0!==this.length&&(l=this[0],l.toDataURL&&(n===r&&(n=1),p=l.toDataURL("image/"+g,n)));return p};g.fn.detectPixelRatio=function(h){var n,l,r,w,t,D,G;for(l=0;l<this.length;l+=1)n=this[l],g(this[l]),r=K(n),G=E(this[l]),G.scaled||(w=window.devicePixelRatio||1,t=r.webkitBackingStorePixelRatio||r.mozBackingStorePixelRatio||r.msBackingStorePixelRatio||r.oBackingStorePixelRatio||r.backingStorePixelRatio||1,w/=t,1!==w&&(t=
n.width,D=n.height,n.width=t*w,n.height=D*w,n.style.width=t+"px",n.style.height=D+"px",r.scale(w,w)),G.pixelRatio=w,G.scaled=p,h&&h.call(n,w));return this};W.clearCache=function(){for(var g in aa)aa.hasOwnProperty(g)&&(aa[g]={})};g.support.canvas=g("<canvas />")[0].getContext!==r;Y(W,{defaults:la,setGlobalProps:R,transformShape:Q,detectEvents:S,closePath:U,setCanvasFont:ra,measureText:sa});g.jCanvas=W;g.jCanvasObject=G})(jQuery,document,Image,Array,Math,parseFloat,!0,!1,null);
